...
public class CNPSP extends Cliente {
    public CNPSP(String nombre, int dni, LocalDate fechaPrestamo, double monto, LocalDate fechaPactadaPago) {
    ...
    public void mostrarInformacion(int meses) {
        System.out.println("Cliente que no presta servicios publicos");
